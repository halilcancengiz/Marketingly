            ...
            <div className="max-w-[1173px] w-full mx-auto flex lg:flex-row flex-col relative">
                ...
                <motion.div
                    ...
                    <div id="terms-and-conditions" className="flex flex-col">
                        ...
                        <div className="text-neutral-800 tb-bold md:text-[24px] xs:text-[22px] text-[20px] lg:mb-4 mb-[10px] md:leading-[34.008px] xs:leading-[31.174px] leading-[28.34px]">Use Terms for Marketing X app</div>
                    ...
                    <div id="privacy-policy" className="flex flex-col">
                        ...
                        <div className="text-neutral-600 text-[18px] tb-medium leading-[30.006px]">Enim nec dui nunc mattis enim vulputate eu scelerisque felis imperdiet proin fermentum leo vel proin sed libero enim sed faucibus turpis at lectus urna duis convallis convallis at tellus at urna condimentum mattis pellentesque id nibh nibh cras pulvinar mattis nunc sed.</div>
