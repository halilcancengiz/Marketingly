...
export const HomeV1 = () => {
    ...
    return (
        <main className="flex flex-col overflow-x-hidden 2xl:bg-white xl:bg-red-200 lg:bg-blue-200 md:bg-purple-400 sm:bg-pink-300 bg-white">
            <section className="flex items-center px-6 justify-center h-full relative bg-white">
                <div className="max-w-[1173px] h-full w-full mx-auto lg:py-[116px] py-[60px] grid lg:grid-cols-2 grid-cols-1 items-center justify-center lg:gap-8 gap-20 relative ">
                    <motion.div
                        ...
                        <motion.div variants={item} className="text-primary uppercase mb-5 tb-medium text-base tracking-[1.6px]">Marketing Agentur</motion.div>
                ...
                <div className="max-w-[1173px] w-full mx-auto flex lg:flex-row flex-col lg:items-center  justify-between">
                    <div className="max-w-[487px] lg:mb-0 mb-20 mt-66px lg:w-auto w-full min-w-[288px] flex flex-col lg:mr-10 ">
                        ...
                        <div className='grid xs:grid-cols-2 gap-x-[32px] md:gap-y-0 gap-y-4 md:flex-nowrap flex-wrap'>
                            <div style={{ boxShadow: "rgba(99, 99, 99, 0.2) 0px 2px 8px 0px" }} className='col-span-1 flex xs:flex-col flex-row gap-x-3 hover-down lg:rounded-[24px] md:rounded-[20px] rounded-[15px] md:py-[34px] sm:py-[28px] py-[24px] px-[22px]'>
