    ...
    <div className="flex flex-col">
      <div className="bg-secondary4 3xl:h-[642px] lg:h-[560px] md:h-[475px] h-[401px]  3xl:pt-[126px] lg:pt-[100px] md:pt-[60px] xs:pt-[50px] pt-[40px] 3xl:pb-[281px] lg:pb-[225px] md:pb-[200px] pb-[160px] relative overflow-hidden">
        <div className="flex flex-col items-center justify-center text-center text-white max-w-[481px] px-6 w-full mx-auto">
          <motion.div
            ...
            className="md:mb-5 xs:mb-[15px] mb-[10px] tb-medium text-base leading-[18px] uppercase">Unsere Social Media Pläne</motion.div>
          <motion.h1
            variants={fadeInAnimationVariant}
            initial="initial"
            whileInView="animate"
      ...
      <section className="md:-mt-28 -mt-20 px-6 flex flex-col z-[6]">
        <motion.div
          ...
          {/* Basis */}
          <div onClick={() => navigate("/social-media-ads-basis", { replace: true })} aria-label="Open basic package detail page" className="cursor-pointer col-span-1 w-full shadow-sm max-w-[660px] mx-auto 3xl:-mt-32 lg:-mt-[68px] md:-mt-[32px] xs:-mt-[32px] -mt-[32px] hover-up-md group bg-white flex flex-col md:pb-12 xs:pb-10 pb-[33px] md:pt-[42px] xs:pt-[35px] pt-[30px] xs:px-[30px] px-[25px] border border-neutral-300 rounded-[20px] relative overflow-hidden">
            ...
            <div style={{ height: heights.checklistHeight }} className="flex flex-col gap-[16px] mb-10">
              <div className="flex items-start gap-[13px]">
                ...
                <div className="leading-[20px] text-neutral-600 text-[18px] tb-medium">Begrenzt auf eine Social Media Plattform Ihrer Wahl
                </div>
              </div>
              <div className="flex items-start gap-[13px]">
                <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
                <div className="leading-[20px] text-neutral-600 text-[18px] tb-medium">Verwaltung von Werbebudgets bis zu <span className="whitespace-nowrap tb-medium">{APP_CONFIG.campaign_limits.Social_Media_Ads.basis} €</span></div>
              </div>
              <div className="flex items-start gap-[13px]">
                <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
                <div className="leading-[20px] text-neutral-600 text-[18px] tb-medium">Einrichtung und grundlegende Verwaltung von Social Media Ads-Kampagnen</div>
              </div>
              <div className="flex items-start gap-[13px]">
                <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
          ...
          {/* Standart */}
          <div onClick={() => navigate("/social-media-ads-standard", { replace: true })} aria-label="Open standart package detail page" className="cursor-pointer col-span-1 w-full shadow-sm max-w-[660px] mx-auto 3xl:-mt-32 lg:-mt-[68px] md:-mt-[32px] xs:-mt-[32px] -mt-[32px] hover-up-md group bg-white flex flex-col md:pb-12 xs:pb-10 pb-[33px] md:pt-[42px] xs:pt-[35px] pt-[30px] xs:px-[30px] px-[25px] border border-neutral-300 rounded-[20px] relative overflow-hidden">
            ...
            <div ref={cardTopHeaderRef} className="flex flex-col">
              ...
              <div className="text-[18px] leading-[30.006px] text-neutral-600 tb-medium">Das ideale Paket für ambitionierte Ziele.</div>
            </div>
            ...
            <div style={{ height: heights.checklistHeight }} className="flex flex-col gap-[16px] mb-10">
              <div className="flex items-start gap-[13px]">
                <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
                <div className="leading-[20px] text-neutral-600 text-[18px] tb-medium">Begrenzt auf zwei Social Media Plattformen Ihrer Wahl</div>
              </div>
              <div className="flex items-start gap-[13px]">
                <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
          ...
          {/* Premium */}
          <div onClick={() => navigate("/social-media-ads-premium", { replace: true })} aria-label="Open premium package detail page" className="cursor-pointer col-span-1 w-full shadow-sm max-w-[660px] mx-auto 3xl:-mt-32 lg:-mt-[68px] md:-mt-[32px] xs:-mt-[32px] -mt-[32px] hover-up-md group bg-white flex flex-col md:pb-12 xs:pb-10 pb-[33px] md:pt-[42px] xs:pt-[35px] pt-[30px] xs:px-[30px] px-[25px] border border-neutral-300 rounded-[20px] relative overflow-hidden">
            ...
            <div ref={checkListRef} className="flex flex-col gap-[16px] mb-10">
              <div className="flex items-start gap-[13px]">
                <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
                <div className="leading-[20px] text-neutral-600 text-[18px] tb-medium">Unbegrenzte Social Media Plattformen</div>
              </div>
              <div className="flex items-start gap-[13px]">
                <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
...
export default SocialMediaAdsPreise