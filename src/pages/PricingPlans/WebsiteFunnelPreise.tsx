...
const WebsiteFunnelPreise = () => {
  ...
  return (
    <div className="flex flex-col">
      ...
      <Helmet>
        <title>Website-Funnel Preise | Superagentur</title>
        <meta property="og:title" content="Website-Funnel Preise | Superagentur" />
        <meta name="description" content="Klare Preise für optimierte Funnels, die Conversions steigern und Ihren Umsatz maximieren." />
        <meta property="og:description" content="Klare Preise für optimierte Funnels, die Conversions steigern und Ihren Umsatz maximieren." />
        <meta name="robots" content="index, follow" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content={`${APP_CONFIG.base_url}websitefunnel-preise`} />
        <meta property="og:image" content={logo} />
        <link rel="canonical" href="https://superagentur-marketing.de/websitefunnel-preise" />
      </Helmet>
      ...
      <div className="bg-secondary4 3xl:h-[642px] lg:h-[560px] md:h-[475px] h-[401px]  3xl:pt-[126px] lg:pt-[100px] md:pt-[60px] xs:pt-[50px] pt-[40px] 3xl:pb-[281px] lg:pb-[225px] md:pb-[200px] pb-[160px] relative overflow-hidden">
        <div className="flex flex-col items-center justify-center text-center text-white max-w-[481px] px-6 w-full mx-auto">
          <motion.div
            ...
            className="md:mb-5 xs:mb-[15px] mb-[10px] tb-medium text-base leading-[18px] uppercase">Unsere Website-Funnel Pläne</motion.div>
          <motion.h1
            variants={fadeInAnimationVariant}
            initial="initial"
            whileInView="animate"
      ...
      <section className="md:-mt-28 -mt-20 px-6 flex flex-col z-[6]">
        <motion.div
          ...
          {/* Basis */}
          <div onClick={() => navigate("/websitefunnel-basis", { replace: true })} aria-label="Open basic package detail page" className="cursor-pointer col-span-1 w-full shadow-sm max-w-[660px] mx-auto 3xl:-mt-32 lg:-mt-[68px] md:-mt-[32px] xs:-mt-[32px] -mt-[32px] hover-up-md group bg-white flex flex-col md:pb-12 xs:pb-10 pb-[33px] md:pt-[42px] xs:pt-[35px] pt-[30px] xs:px-[30px] px-[25px] border border-neutral-300 rounded-[20px] relative overflow-hidden">
            ...
            <div style={{ height: heights.checklistHeight }} className="flex flex-col gap-[16px] mb-10">
              <div className="flex items-start gap-[13px]">
                ...
                <div className="leading-[20px] text-neutral-600 text-[18px] tb-medium">Erstellung eines simplen Funnels zur Lead-Generierung</div>
              </div>
              <div className="flex items-start gap-[13px]">
                <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
                <div className="leading-[20px] text-neutral-600 text-[18px] tb-medium">DSGVO-konforme Aufsetzung</div>
              </div>
              <div className="flex items-start gap-[13px]">
                <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
                <div className="leading-[20px] text-neutral-600 text-[18px] tb-medium">Optimiert für erste Kampagnen und Conversions</div>
              </div>
              <div className="flex items-start gap-[13px]">
                <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              ...
              <div className="flex items-start gap-[13px]">
                <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
                <div className="leading-[20px] text-neutral-600 text-[18px] tb-medium">Grundlegende Betreuung und Support</div>
              </div>
              <br />
            </div>
          ...
          {/* Standart */}
          <div onClick={() => navigate("/websitefunnel-standard", { replace: true })} aria-label="Open standart package detail page" className="cursor-pointer col-span-1 w-full shadow-sm max-w-[660px] mx-auto 3xl:-mt-32 lg:-mt-[68px] md:-mt-[32px] xs:-mt-[32px] -mt-[32px] hover-up-md group bg-white flex flex-col md:pb-12 xs:pb-10 pb-[33px] md:pt-[42px] xs:pt-[35px] pt-[30px] xs:px-[30px] px-[25px] border border-neutral-300 rounded-[20px] relative overflow-hidden">
            ...
            <div ref={checkListRef} className="flex flex-col gap-[16px] mb-10">
              ...
              <div className="flex items-start gap-[13px]">
                <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
                <div className="leading-[20px] text-neutral-600 text-[18px] tb-medium">Monatliche Berichte mit detaillierten Analysen zur Funnel-Leistung </div>
              </div>
              <div className="flex items-start gap-[13px]">
                <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
                <div className="leading-[20px] text-neutral-600 text-[18px] tb-medium">Persönlicher Ansprechpartner für strategische Beratung und Support</div>
              </div>
              <div className="flex items-start gap-[13px]">
                <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
                <div className="leading-[20px] text-neutral-600 text-[18px] tb-medium">Erweiterte Automatisierungen zur Verbesserung des Funnel-Flows</div>
              </div>
            </div>
            <Button className="tb-bold">Details</Button>
          </div>
          ...
          {/* Premium */}
          <div onClick={() => navigate("/websitefunnel-premium", { replace: true })} aria-label="Open premium package detail page" className="cursor-pointer col-span-1 w-full shadow-sm max-w-[660px] mx-auto 3xl:-mt-32 lg:-mt-[68px] md:-mt-[32px] xs:-mt-[32px] -mt-[32px] hover-up-md group bg-white flex flex-col md:pb-12 xs:pb-10 pb-[33px] md:pt-[42px] xs:pt-[35px] pt-[30px] xs:px-[30px] px-[25px] border border-neutral-300 rounded-[20px] relative overflow-hidden">
            ...
            <div style={{ height: heights.checklistHeight }} className="flex flex-col gap-[16px] mb-10">
              ...
              <div className="flex items-start gap-[13px]">
                <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
                <div className="leading-[20px] text-neutral-600 text-[18px] tb-medium">Erweiterte Automatisierungen und dynamische A/B-Tests zur Optimierung</div>
              </div>
              <div className="flex items-start gap-[13px]">
                <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
                <div className="leading-[20px] text-neutral-600 text-[18px] tb-medium">Dynamische Anpassungen basierend auf Echtzeit-Daten und Nutzerverhalten</div>
              </div>
              <div className="flex items-start gap-[13px]">
                <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
                <div className="leading-[20px] text-neutral-600 text-[18px] tb-medium">Regelmäßige Optimierung für maximale Kampagnenleistung und Conversions</div>
              </div>
              <div className="flex items-start gap-[13px]">
                <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
                <div className="leading-[20px] text-neutral-600 text-[18px] tb-medium">Strategische Planung und fortlaufende Betreuung durch Experten</div>
              </div>
              <div className="flex items-start gap-[13px]">
                <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
                <div className="leading-[20px] text-neutral-600 text-[18px] tb-medium">Monatliches Reporting zur Analyse und Verbesserung</div>
              </div>
            </div>
            <Button className="tb-bold">Details</Button>
...
export default WebsiteFunnelPreise