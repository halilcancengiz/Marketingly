  ...
  return (
    <div className="flex flex-col">
      ...
      <Helmet>
        ...
        <meta name="description" content="Unsere SEO-Preise bieten faire und transparente Lösungen für nachhaltigen Erfolg in den Suchmaschinen." />
        <meta property="og:description" content="Unsere SEO-Preise bieten faire und transparente Lösungen für nachhaltigen Erfolg in den Suchmaschinen." />
      ...
      <div className="bg-secondary4 3xl:h-[642px] lg:h-[560px] md:h-[475px] h-[401px]  3xl:pt-[126px] lg:pt-[100px] md:pt-[60px] xs:pt-[50px] pt-[40px] 3xl:pb-[281px] lg:pb-[225px] md:pb-[200px] pb-[160px] relative overflow-hidden">
        <div className="flex flex-col items-center justify-center text-center text-white max-w-[481px] px-6 w-full mx-auto">
          <motion.div
            ...
            className="md:mb-5 xs:mb-[15px] mb-[10px] tb-medium text-base leading-[18px] uppercase">Unsere SEO Pläne</motion.div>
          <motion.h1
            variants={fadeInAnimationVariant}
            initial="initial"
            whileInView="animate"
      ...
      <section className="md:-mt-28 -mt-20 px-6 flex flex-col z-[6]">
        <motion.div
          ...
          {/* Basis */}
          <div onClick={() => navigate("/seo-basis", { replace: true })} aria-label="Open basic package detail page" className="cursor-pointer col-span-1 w-full shadow-sm max-w-[660px] mx-auto 3xl:-mt-32 lg:-mt-[68px] md:-mt-[32px] xs:-mt-[32px] -mt-[32px] hover-up-md group bg-white flex flex-col md:pb-12 xs:pb-10 pb-[33px] md:pt-[42px] xs:pt-[35px] pt-[30px] xs:px-[30px] px-[25px] border border-neutral-300 rounded-[20px] relative overflow-hidden">
            ...
            <div style={{ height: heights.headerHeight }} className="flex flex-col">
              ...
              <div className="text-[18px] leading-[30.006px] text-neutral-600 tb-medium">Perfekt für den Einstieg in SEO.<span className="lg:flex hidden"></span> </div>
            </div>
          ...
          {/* Standart */}
          <div onClick={() => navigate("/seo-standard", { replace: true })} aria-label="Open standart package detail page" className="cursor-pointer col-span-1 w-full shadow-sm max-w-[660px] mx-auto 3xl:-mt-32 lg:-mt-[68px] md:-mt-[32px] xs:-mt-[32px] -mt-[32px] hover-up-md group bg-white flex flex-col md:pb-12 xs:pb-10 pb-[33px] md:pt-[42px] xs:pt-[35px] pt-[30px] xs:px-[30px] px-[25px] border border-neutral-300 rounded-[20px] relative overflow-hidden">
            ...
            <div style={{ height: heights.headerHeight }} className="flex flex-col">
              ...
              <div className="text-[18px] leading-[30.006px] text-neutral-600 tb-medium">Ideal für ambitionierte Ziele.</div>
            </div>
          ...
          {/* Premium */}
          <div onClick={() => navigate("/seo-premium", { replace: true })} aria-label="Open premium package detail page" className="cursor-pointer col-span-1 w-full shadow-sm max-w-[660px] mx-auto 3xl:-mt-32 lg:-mt-[68px] md:-mt-[32px] xs:-mt-[32px] -mt-[32px] hover-up-md group bg-white flex flex-col md:pb-12 xs:pb-10 pb-[33px] md:pt-[42px] xs:pt-[35px] pt-[30px] xs:px-[30px] px-[25px] border border-neutral-300 rounded-[20px] relative overflow-hidden">
