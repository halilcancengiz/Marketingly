  ...
  return (
    <section className="3xl:pt-[95px] lg:pt-[75px] md:pt-[60px] xs:pt-[50px] pt-[40px] 3xl:pb-[136px] lg:pb-[110px] md:pb-[88px] xs:pb-[70px] pb-[60px] px-6 flex items-center justify-center relative">
      ...
      <Helmet>
        ...
        <meta name="description" content="Einstiegslösungen für effektive Suchmaschinenwerbung, ideal für kleine Budgets mit maximalem Effekt." />
        <meta property="og:description" content="Einstiegslösungen für effektive Suchmaschinenwerbung, ideal für kleine Budgets mit maximalem Effekt." />
        <meta name="robots" content="index, follow" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content={`${APP_CONFIG.base_url}sea-basis`} />
        <meta property="og:image" content={logo} />
        <link rel="canonical" href="https://superagentur-marketing.de/sea-basis" />
      </Helmet>
