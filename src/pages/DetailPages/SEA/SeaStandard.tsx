...
const SeaStandard = () => {
  ...
  return (
    <section className="3xl:pt-[95px] lg:pt-[75px] md:pt-[60px] xs:pt-[50px] pt-[40px] 3xl:pb-[136px] lg:pb-[110px] md:pb-[88px] xs:pb-[70px] pb-[60px] px-6 flex items-center justify-center relative">
      ...
      <Helmet>
        <title>SEA Standard Paket | Superagentur</title>
        <meta property="og:title" content="SEA Standard Paket | Superagentur" />
        <meta name="description" content="Gezielte Suchmaschinenwerbung für mehr Reichweite, Klicks und Conversions – perfekt für wachsende Unternehmen." />
        <meta property="og:description" content="Gezielte Suchmaschinenwerbung für mehr Reichweite, Klicks und Conversions – perfekt für wachsende Unternehmen." />
        <meta name="robots" content="index, follow" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content={`${APP_CONFIG.base_url}sea-standard`} />
        <meta property="og:image" content={logo} />
        <link rel="canonical" href="https://superagentur-marketing.de/sea-standard" />
      </Helmet>
        ...
        <motion.div
          ...
          <div className="flex flex-col gap-[15px] mb-10">
            ...
            <div className="flex items-center gap-[13px]">
              ...
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Verwaltung von Werbebudgets bis zu {APP_CONFIG.campaign_limits.SEA.standard} €</div>
            </div>
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Einrichtung und umfassende Verwaltung von SEA-Kampagnen für Google Ads und Bing Ads mit regelmäßigen Optimierungen</div>
            </div>
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
          ...
          <ul className="pl-10 lg:mt-8 md:mt-[26px] mb-10 list-disc">
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Umfassende Verwaltung auf mehreren Plattformen: Maximale Reichweite durch gezielte Ansprache auf Google Ads und Bing Ads.</li>
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Erweiterte Analysen: Detaillierte Einblicke in die Kampagnenleistung für datenbasierte Entscheidungen.</li>
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Strategische Flexibilität: Schnelle Anpassungen und Optimierungen für eine nachhaltige Performance.</li>
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Individuelle Betreuung: Ihr persönlicher Ansprechpartner sorgt für gezielte Unterstützung und Übersicht.</li>
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Optimierung der Kampagnen: Wir stellen sicher, dass Ihre Ziele mit minimalem Aufwand erreicht werden.</li>
          </ul>
          <div className="leading-[30px] text-neutral-600 text-[18px] tb-medium mb-[28px]">
            Mit dem Standard-Paket bringen Sie Ihre SEA-Kampagnen auf das nächste Level und erreichen langfristigen Erfolg.
          </div>
        </motion.div>
        <motion.div
          variants={fadeInAnimationVariant}
