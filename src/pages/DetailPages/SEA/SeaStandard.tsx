          ...
          <div className="lg:mt-8 md:mt-[26px] mb-10">
            <div className="flex gap-[13px]">
              ...
              <p className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2 flex items-start">
                Umfassende Verwaltung auf mehreren Plattformen: Maximale Reichweite durch gezielte Ansprache auf Google Ads und Bing Ads.
              </p>
            </div>
            <div className="flex gap-[13px]">
              <div className="size-6 flex items-center justify-center">
              ...
              <p className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2 flex items-start">
                Erweiterte Analysen: Detaillierte Einblicke in die Kampagnenleistung für datenbasierte Entscheidungen.
              </p>
            </div>
            <div className="flex gap-[13px]">
              <div className="size-6 flex items-center justify-center">
              ...
              <p className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2 flex items-start">
                Strategische Flexibilität: Schnelle Anpassungen und Optimierungen für eine nachhaltige Performance.
              </p>
            </div>
            <div className="flex gap-[13px]">
              <div className="size-6 flex items-center justify-center">
              ...
              <p className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2 flex items-start">
                Individuelle Betreuung: Ihr persönlicher Ansprechpartner sorgt für gezielte Unterstützung und Übersicht.
              </p>
            </div>
            <div className="flex gap-[13px]">
              <div className="size-6 flex items-center justify-center">
              ...
              <p className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2 flex items-start">
                Optimierung der Kampagnen: Wir stellen sicher, dass Ihre Ziele mit minimalem Aufwand erreicht werden.
              </p>
            </div>
          </div>
          <div className="leading-[30px] text-neutral-600 text-[18px] tb-medium mb-[28px]">
