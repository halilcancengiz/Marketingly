...
const SeaPremium = () => {
  ...
  return (
    <section className="3xl:pt-[95px] lg:pt-[75px] md:pt-[60px] xs:pt-[50px] pt-[40px] 3xl:pb-[136px] lg:pb-[110px] md:pb-[88px] xs:pb-[70px] pb-[60px] px-6 flex items-center justify-center relative">
      ...
      <Helmet>
        <title>SEA Premium Paket | Superagentur</title>
        <meta property="og:title" content="SEA Premium Paket | Superagentur" />
        <meta name="description" content="High-End-Lösungen für Suchmaschinenwerbung, die Ihre Marke an die Spitze bringt und maximale Performance liefert." />
        <meta property="og:description" content="High-End-Lösungen für Suchmaschinenwerbung, die Ihre Marke an die Spitze bringt und maximale Performance liefert." />
        <meta name="robots" content="index, follow" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content={`${APP_CONFIG.base_url}sea-premium`} />
        <meta property="og:image" content={logo} />
        <link rel="canonical" href="https://superagentur-marketing.de/sea-premium" />
      </Helmet>
      ...
      <div className="max-w-[1173px] w-full mx-auto flex lg:flex-row flex-col lg:items-start items-center justify-between z-[2]">
        <motion.div
          ...
          <h2 className="md:mb-[20px] xs:mb-[15px] mb-[10px] text-[16px] leading-[18px] uppercase tb-medium text-primary tracking-[1.5px] mt-10">SEA</h2>
          ...
          <div className="leading-[30px] text-neutral-600 text-[18px] tb-medium mb-[28px]">
            Das Premium-Paket ist die optimale Wahl für Unternehmen mit hohen Ansprüchen.
            Es bietet maximale Flexibilität und umfassende Betreuung auf allen Ebenen Ihrer SEA-Kampagnen.
          </div>
          <div className="flex flex-col gap-[15px] mb-10">
            ...
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Einrichtung und individuelle Kampagnenstrategien für Google Ads und Bing Ads mit fortlaufenden Optimierungen</div>
            </div>
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Monatliches Reporting mit tiefgehenden Analysen</div>
            </div>
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
          ...
          <ul className="pl-10 lg:mt-8 md:mt-[26px] mb-10 list-disc">
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Unbegrenzte Möglichkeiten: Kampagnenstrategie und Budget werden individuell an Ihre Bedürfnisse angepasst.</li>
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Detaillierte Marktanalysen: Umfassende Insights für strategische Entscheidungen und Wettbewerbsvorteile.</li>
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Professionelle Optimierung: Fortlaufende Anpassungen für maximale Performance und Conversions.</li>
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Persönliche Beratung: Direkter Kontakt zu einem Experten für gezielte Unterstützung und Effizienzsteigerung.</li>
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Langfristige Betreuung: Wir begleiten Ihre Kampagnen kontinuierlich, um bestmögliche Ergebnisse zu sichern.</li>
          </ul>
          <div className="leading-[30px] text-neutral-600 text-[18px] tb-medium mb-[28px]">
            Mit dem Premium-Paket setzen Sie neue Maßstäbe in Ihrer SEA-Strategie und maximieren Ihren Erfolg.
          </div>
        </motion.div>
        <motion.div
          variants={fadeInAnimationVariant}
