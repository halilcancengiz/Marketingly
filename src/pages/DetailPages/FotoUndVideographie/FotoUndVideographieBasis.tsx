...
const FotoUndVideographieBasis = () => {
  ...
  return (
    <section className="3xl:pt-[95px] lg:pt-[75px] md:pt-[60px] xs:pt-[50px] pt-[40px] 3xl:pb-[136px] lg:pb-[110px] md:pb-[88px] xs:pb-[70px] pb-[60px] px-6 flex items-center justify-center relative">
      ...
      <Helmet>
        <title>Foto & Videographie Basis Paket | Superagentur</title>
        <meta property="og:title" content="Foto & Videographie Basis Paket | Superagentur" />
        <meta name="description" content="Perfekte Visuals für ansprechende und professionelle Markenauftritte – ideal für Einsteiger." />
        <meta property="og:description" content="Perfekte Visuals für ansprechende und professionelle Markenauftritte – ideal für Einsteiger." />
        <meta name="robots" content="index, follow" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content={`${APP_CONFIG.base_url}foto-und-videographie-basis`} />
        <meta property="og:image" content={logo} />
        <link rel="canonical" href="https://superagentur-marketing.de/foto-und-videographie-basis" />
      </Helmet>
      ...
      <div className="max-w-[1173px] w-full mx-auto flex lg:flex-row flex-col lg:items-start items-center justify-between z-[2]">
        <motion.div
          ...
          <h2 className="md:mb-[20px] xs:mb-[15px] mb-[10px] text-[16px] leading-[18px] uppercase tb-medium text-primary tracking-[1.5px] mt-10">Foto- & Videographie</h2>
          ...
          <div className="flex flex-col gap-[15px] mb-10">
            ...
            <div className="flex items-center gap-[13px]">
              ...
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">20 professionelle Fotos</div>
            </div>
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">3 kurze Videos (je 30 Sekunden bis 2 Minuten)</div>
            </div>
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Bearbeitung und Optimierung der Inhalte</div>
            </div>
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Simpler Videoschnitt und Nachproduktion (Basis-Titel, einfache Übergänge)</div>
            </div>
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Lieferung in digitalen Formaten</div>
            </div>
          </div>
          ...
          <ul className="pl-10 lg:mt-8 md:mt-[26px] mb-10 list-disc">
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Schnelle und effiziente Erstellung von Foto- und Video-Inhalten</li>
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Ideal für Social Media, kleine Kampagnen oder Produktpräsentationen</li>
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Klare, einfache Nachbearbeitung für einen professionellen Look</li>
          </ul>
...
export default FotoUndVideographieBasis