          ...
          <div className="lg:mt-8 md:mt-[26px] mb-10">
            <div className="flex gap-[13px]">
              ...
              <p className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2 flex items-start">
                Maßgeschneiderte Inhalte, perfekt abgestimmt auf Ihre Bedürfnisse
              </p>
            </div>
            <div className="flex gap-[13px]">
              <div className="size-6 flex items-center justify-center">
              ...
              <p className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2 flex items-start">
                Hochwertige Videos und Fotos für professionelle Präsentationen, Kampagnen oder Events
              </p>
            </div>
            <div className="flex gap-[13px]">
              <div className="size-6 flex items-center justify-center">
              ...
              <p className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2 flex items-start">
                Langfristige Betreuung und Expertise für nachhaltigen Erfolg
              </p>
            </div>
