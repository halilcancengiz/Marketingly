...
const MarketingRessourcenStandard = () => {
  ...
  return (
    <section className="3xl:pt-[95px] lg:pt-[75px] md:pt-[60px] xs:pt-[50px] pt-[40px] 3xl:pb-[136px] lg:pb-[110px] md:pb-[88px] xs:pb-[70px] pb-[60px] px-6 flex items-center justify-center relative">
      ...
      <Helmet>
        <title>Marketing-Ressourcen Standard Paket | Superagentur</title>
        <meta property="og:title" content="Marketing-Ressourcen Standard Paket | Superagentur" />
        <meta name="description" content="Marketing-Ressourcen für Unternehmen – umfassende Lösungen für effiziente Kampagnen und Ergebnisse." />
        <meta property="og:description" content="Marketing-Ressourcen für Unternehmen – umfassende Lösungen für effiziente Kampagnen und Ergebnisse." />
        <meta name="robots" content="index, follow" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content={`${APP_CONFIG.base_url}marketing-ressourcen-standard`} />
        <meta property="og:image" content={logo} />
        <link rel="canonical" href="https://superagentur-marketing.de/marketing-ressourcen-standard" />
      </Helmet>
      ...
      <div className="max-w-[1173px] w-full mx-auto flex lg:flex-row flex-col lg:items-start items-center justify-between z-[2]">
        <motion.div
          ...
          <div className="leading-[30px] text-neutral-600 text-[18px] tb-medium mb-[28px]">
            Das Standard-Paket eignet sich für Unternehmen mit erweiterten Anforderungen, die hochwertige, animierte Inhalte und Konzepte benötigen, um ihre Kampagnen auf die nächste Stufe zu bringen.
          </div>
          <div className="flex flex-col gap-[15px] mb-10">
            ...
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Unterschiedliche Konzepte zur Auswahl basierend auf Wettbewerbsanalyse</div>
            </div>
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Überprüfung nach Werberichtlinien</div>
            </div>
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Integration animierter Grafiken für ansprechendere Inhalte</div>
            </div>
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
          ...
          <ul className="pl-10 lg:mt-8 md:mt-[26px] mb-10 list-disc">
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Höhere Flexibilität durch die Auswahl aus verschiedenen Konzepten </li>
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Einsatz animierter Inhalte für eine stärkere visuelle Wirkung</li>
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Ideal für komplexere Kampagnen und Social-Media-Strategien</li>
...
export default MarketingRessourcenStandard