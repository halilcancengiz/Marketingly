...
const MarketingRessourcenBasis = () => {
  ...
  return (
    <section className="3xl:pt-[95px] lg:pt-[75px] md:pt-[60px] xs:pt-[50px] pt-[40px] 3xl:pb-[136px] lg:pb-[110px] md:pb-[88px] xs:pb-[70px] pb-[60px] px-6 flex items-center justify-center relative">
      ...
      <Helmet>
        <title>Marketing-Ressourcen Basis Paket | Superagentur</title>
        <meta property="og:title" content="Marketing-Ressourcen Basis Paket | Superagentur" />
        <meta name="description" content="Marketing-Ressourcen für den Start – effektive Grafiken und Inhalte für Ihre erste erfolgreiche Strategie." />
        <meta property="og:description" content="Marketing-Ressourcen für den Start – effektive Grafiken und Inhalte für Ihre erste erfolgreiche Strategie." />
        <meta name="robots" content="index, follow" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content={`${APP_CONFIG.base_url}marketing-ressourcen-basis`} />
        <meta property="og:image" content={logo} />
        <link rel="canonical" href="https://superagentur-marketing.de/marketing-ressourcen-basis" />
      </Helmet>
      ...
      <div className="max-w-[1173px] w-full mx-auto flex lg:flex-row flex-col lg:items-start items-center justify-between z-[2]">
        <motion.div
          ...
          <div className="leading-[30px] text-neutral-600 text-[18px] tb-medium mb-[28px]">
            Das Basis-Paket ist ideal für Unternehmen, die schnell und effizient hochwertige Grafiken für ihre Social-Media-Präsenz oder kleinere Kampagnen benötigen.
            Es bietet eine kostengünstige und professionelle Lösung für den Einstieg.
          </div>
          <div className="flex flex-col gap-[15px] mb-10">
            ...
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Anpassung an Ihr Corporate Design</div>
            </div>
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
            ...
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Optimiert für Social Media und einfache Kampagnen</div>
            </div>
          ...
          <ul className="pl-10 lg:mt-8 md:mt-[26px] mb-10 list-disc">
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Schnelle und professionelle Erstellung von Marketingmaterialien</li>
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Perfekt geeignet für kleinere Kampagnen oder Social-Media-Beiträge</li>
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Effizient und budgetfreundlich</li>
...
export default MarketingRessourcenBasis