...
const MarketingRessourcenPremium = () => {
  ...
  return (
    <section className="3xl:pt-[95px] lg:pt-[75px] md:pt-[60px] xs:pt-[50px] pt-[40px] 3xl:pb-[136px] lg:pb-[110px] md:pb-[88px] xs:pb-[70px] pb-[60px] px-6 flex items-center justify-center relative">
      ...
      <Helmet>
        <title>Marketing-Ressourcen Premium Paket | Superagentur</title>
        <meta property="og:title" content="Marketing-Ressourcen Premium Paket | Superagentur" />
        <meta name="description" content="Premium-Marketing-Ressourcen – hochwertige Grafiken, die Ihre Kampagnen auf das nächste Level bringen." />
        <meta property="og:description" content="Premium-Marketing-Ressourcen – hochwertige Grafiken, die Ihre Kampagnen auf das nächste Level bringen." />
        <meta name="robots" content="index, follow" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content={`${APP_CONFIG.base_url}marketing-ressourcen-premium`} />
        <meta property="og:image" content={logo} />
        <link rel="canonical" href="https://superagentur-marketing.de/marketing-ressourcen-premium" />
      </Helmet>
      ...
      <div className="max-w-[1173px] w-full mx-auto flex lg:flex-row flex-col lg:items-start items-center justify-between z-[2]">
        <motion.div
          ...
          <h2 className="md:mb-[20px] xs:mb-[15px] mb-[10px] text-[16px] leading-[18px] uppercase tb-medium text-primary tracking-[1.5px] mt-10">Marketing-Ressourcen</h2>
          ...
          <div className="leading-[30px] text-neutral-600 text-[18px] tb-medium mb-[28px]">
            Das Premium-Paket bietet eine maßgeschneiderte Lösung für Unternehmen, die maximale Qualität und Flexibilität benötigen.
            Es ist perfekt für umfangreiche Kampagnen, die auf eine detaillierte Wettbewerbsanalyse und hochgradig personalisierte Inhalte setzen.
          </div>
          <div className="flex flex-col gap-[15px] mb-10">
            ...
            <div className="flex items-center gap-[13px]">
              ...
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Erstellung einer individuellen Anzahl an Grafiken</div>
            </div>
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Entwicklung unterschiedlicher Konzepte basierend auf detaillierten Marktanalysen</div>
            </div>
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Überprüfung und Optimierung nach Werberichtlinien und Plattformanforderungen</div>
            </div>
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Integration aufwändiger Animationen für höchste visuelle Qualität</div>
            </div>
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Optimiert für Social Media und fortgeschrittene Kampagnen</div>
            </div>
          </div>
          ...
          <ul className="pl-10 lg:mt-8 md:mt-[26px] mb-10 list-disc">
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Maßgeschneiderte Inhalte, perfekt auf Ihre Bedürfnisse abgestimmt</li>
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Nutzung hochentwickelter Animationen und visueller Effekte</li>
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Ideale Lösung für umfassende Marketingkampagnen und Markenaufbau</li>
          </ul>
        </motion.div>
        <motion.div
          variants={fadeInAnimationVariant}
          ...
          <div className="flex flex-col">
            ...
            <div className="leading-[30px] text-neutral-600 text-[18px] tb-medium">
              Wir helfen Ihnen, Ihre Marketing-Ressourcen-Ziele zu erreichen. Erfahren Sie mehr über Ihre Möglichkeiten und lassen Sie uns gemeinsam wachsen.
            </div>
...
export default MarketingRessourcenPremium