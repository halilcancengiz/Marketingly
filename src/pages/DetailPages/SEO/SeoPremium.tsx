  ...
  return (
    <section className="3xl:pt-[95px] lg:pt-[75px] md:pt-[60px] xs:pt-[50px] pt-[40px] 3xl:pb-[136px] lg:pb-[110px] md:pb-[88px] xs:pb-[70px] pb-[60px] px-6 flex items-center justify-center relative">
      ...
      <Helmet>
        ...
        <meta name="description" content="Spitzenoptimierung für maximale Suchmaschinen-Rankings und eine starke Online-Präsenz." />
        <meta property="og:description" content="Spitzenoptimierung für maximale Suchmaschinen-Rankings und eine starke Online-Präsenz." />
        <meta name="robots" content="index, follow" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content={`${APP_CONFIG.base_url}seo-premium`} />
        <meta property="og:image" content={logo} />
        <link rel="canonical" href="https://superagentur-marketing.de/seo-premium" />
      </Helmet>
      ...
      <div className="max-w-[1173px] w-full mx-auto flex lg:flex-row flex-col lg:items-start items-center justify-between z-[2]">
        <motion.div
          ...
          <h2 className="md:mb-[20px] xs:mb-[15px] mb-[10px] text-[16px] leading-[18px] uppercase tb-medium text-primary tracking-[1.5px] mt-10">SEO</h2>
          ...
          <div className="leading-[30px] text-neutral-600 text-[18px] tb-medium mb-[28px]">
            Das Premium-Paket ist die umfassende Lösung für Unternehmen, die maximale Ergebnisse erzielen möchten.
            Wir entwickeln eine maßgeschneiderte Strategie, die perfekt auf Ihre Ziele und Anforderungen abgestimmt ist, und bieten fortlaufende Optimierungen für dauerhaften Erfolg.
          </div>
