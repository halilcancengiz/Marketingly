      ...
      <div className="max-w-[1173px] w-full mx-auto flex lg:flex-row flex-col lg:items-start items-center justify-between z-[2]">
        <motion.div
          ...
          <div className="leading-[30px] text-neutral-600 text-[18px] tb-medium mb-[28px]">
            Das Basis-Paket bietet den perfekten Einstieg in die Suchmaschinenoptimierung. Es richtet sich an Unternehmen, die eine solide Grundlage schaffen möchten, um die Sichtbarkeit in Suchmaschinen zu verbessern.
            Mit gezielten Maßnahmen und einer zuverlässigen Betreuung helfen wir Ihnen, Ihre ersten SEO-Erfolge zu erzielen.
          </div>
          ...
          <div className="lg:mt-8 md:mt-[26px] mb-10">
            <div className="flex gap-[13px]">
              ...
              <p className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2 flex items-start">
                Klare und verständliche SEO-Strategie
              </p>
            </div>
            <div className="flex gap-[13px]">
              <div className="size-6 flex items-center justify-center">
              ...
              <p className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2 flex items-start">
                Regelmäßige Anpassungen basierend auf Ihren Bedürfnissen
              </p>
            </div>
            <div className="flex gap-[13px]">
              <div className="size-6 flex items-center justify-center">
              ...
              <p className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2 flex items-start">
                Transparente Kommunikation mit unserem Team
              </p>
            </div>
            <div className="flex gap-[13px]">
              <div className="size-6 flex items-center justify-center">
              ...
              <p className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2 flex items-start">
                Fokus auf schnelle und nachhaltige Ergebnisse
              </p>
            </div>
