...
const UnternehmenslistungPremium = () => {
...
{/* 
      <Helmet>
        <title>Unternehmenslistung Premium Paket | Superagentur</title>
        <meta property="og:title" content="Unternehmenslistung Premium Paket | Superagentur" />
        <meta name="description" content="Google My Business Premium – Optimierte Einträge für höchste Präsenz auf lokalen und globalen Plattformen." />
        <meta property="og:description" content="Google My Business Premium – Optimierte Einträge für höchste Präsenz auf lokalen und globalen Plattformen." />
        <meta name="robots" content="index, follow" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content={`${APP_CONFIG.base_url}unternehmenslistung-premium`} />
        <meta property="og:image" content={logo} />
        <link rel="canonical" href="https://superagentur-marketing.de/unternehmenslistung-premium" />
      </Helmet> */}
      ...
      <div className="max-w-[1173px] w-full mx-auto flex lg:flex-row flex-col lg:items-start items-center justify-between z-[2]">
        <motion.div
          ...
          <h2 className="md:mb-[20px] xs:mb-[15px] mb-[10px] text-[16px] leading-[18px] uppercase tb-medium text-primary tracking-[1.5px] mt-10">Unternehmenslistung</h2>
          ...
          <div className="leading-[30px] text-neutral-600 text-[18px] tb-medium mb-[28px]">
            Das Premium-Paket ist speziell für Unternehmen konzipiert, die ihre Sichtbarkeit steigern und einen professionellen Auftritt auf Google sicherstellen möchten.
            Mit unserer umfassenden Unternehmenslistung wird Ihr Unternehmen optimal auffindbar und hinterlässt einen überzeugenden ersten Eindruck.
          </div>
          ...
          <div className="lg:mt-8 md:mt-[26px] mb-10">
            ...
            <div className="flex gap-[13px]">
              ...
              <p className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2 flex items-start">
                Erhöhte Auffindbarkeit in Google-Suchen und Maps
              </p>
            </div>
            <div className="flex gap-[13px]">
              <div className="size-6 flex items-center justify-center">
              ...
              <p className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2 flex items-start">
                Professionelle Darstellung Ihrer Dienstleistungen
              </p>
            </div>
            <div className="flex gap-[13px]">
              <div className="size-6 flex items-center justify-center">
              ...
              <p className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2 flex items-start">
                Maximale Effizienz durch Expertenwissen
              </p>
            </div>
...
export default UnternehmenslistungPremium