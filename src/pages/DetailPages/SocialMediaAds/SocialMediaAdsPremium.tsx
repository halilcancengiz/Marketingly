...
const SocialMediaAdsPremium = () => {
  ...
  return (
    <section className="3xl:pt-[95px] lg:pt-[75px] md:pt-[60px] xs:pt-[50px] pt-[40px] 3xl:pb-[136px] lg:pb-[110px] md:pb-[88px] xs:pb-[70px] pb-[60px] px-6 flex items-center justify-center relative">
      ...
      <Helmet>
        <title>Social Media Ads Premium Paket | Superagentur</title>
        <meta property="og:title" content="Social Media Ads Premium Paket | Superagentur" />
        <meta name="description" content="Social Media Ads für maximale Performance – strategische Lösungen für hohe Reichweite und optimale Ergebnisse." />
        <meta property="og:description" content="Social Media Ads für maximale Performance – strategische Lösungen für hohe Reichweite und optimale Ergebnisse." />
        <meta name="robots" content="index, follow" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content={`${APP_CONFIG.base_url}social-media-ads-premium`} />
        <meta property="og:image" content={logo} />
        <link rel="canonical" href="https://superagentur-marketing.de/social-media-ads-premium" />
      ...
      <div className="max-w-[1173px] w-full mx-auto flex lg:flex-row flex-col lg:items-start items-center justify-between z-[2]">
        <motion.div
          ...
          <div className="leading-[30px] text-neutral-600 text-[18px] tb-medium mb-[28px]">
            Das Premium-Paket bietet Unternehmen eine maßgeschneiderte und umfassende Lösung für ihre Social Media Werbung, die durch strategische Ansätze und flexible Umsetzungen auf nachhaltige Ergebnisse abzielt.
          </div>
          <div className="flex flex-col gap-[15px] mb-10">
            ...
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Umfassende Berichte zur Kampagnenleistung mit detaillierten Einblicken</div>
            </div>
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Direkter Ansprechpartner für individuelle Betreuung</div>
            </div>
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Unbegrenzte Social Media Plattformen</div>
            </div>
          </div>
          ...
          <ul className="pl-10 lg:mt-8 md:mt-[26px] mb-10 list-disc">
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Flexible Anpassung Ihrer Kampagnen an Markttrends, Zielgruppenveränderungen und Marketingziele</li>
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Tiefgehende Analysen Ihrer Zielgruppen und Wettbewerbsdaten</li>
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Fokussierte Strategien für langfristigen Erfolg und nachhaltige Ergebnisse</li>
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Kontinuierliche Überwachung und Optimierung zur Steigerung Ihrer Performance</li>
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Exklusive Beratung und individuell abgestimmte Lösungen</li>
          </ul>
          <div className="leading-[30px] text-neutral-600 text-[18px] tb-medium mb-[28px]">
            Unsere Premium-Lösung konzentriert sich darauf, Ihre Kampagnen kontinuierlich zu optimieren und individuell anzupassen.
            Mit tiefgreifenden Analysen und strategischen Maßnahmen helfen wir Ihnen, Ihre Ziele effizient und erfolgreich zu erreichen.
          </div>
        </motion.div>
        <motion.div
          variants={fadeInAnimationVariant}
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-col my-5">
              <div className="tb-bold text-neutral-800 md:text-[24px] xs:text-[22px] text-[20px] md:leading-[34.008px] xs:leading-[31.174px] leading-[28.34px]">{APP_CONFIG.prices.Social_Media_Ads.premium}</div>
...
export default SocialMediaAdsPremium