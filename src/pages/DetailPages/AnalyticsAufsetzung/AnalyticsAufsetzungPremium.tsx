...
const AnalyticsAufsetzungPremium = () => {
  ...
  return (
    <section className="3xl:pt-[95px] lg:pt-[75px] md:pt-[60px] xs:pt-[50px] pt-[40px] 3xl:pb-[136px] lg:pb-[110px] md:pb-[88px] xs:pb-[70px] pb-[60px] px-6 flex items-center justify-center relative">
      ...
      <Helmet>
        <title>Analytics-Aufsetzung Premium Paket | Superagentur</title>
        <meta property="og:title" content="Analytics-Aufsetzung Premium Paket | Superagentur" />
        <meta name="description" content="High-End-Analytics – Tiefgehende Einrichtung von Google Analytics, Tag Manager und erweitertes Conversion-Tracking für maximale Einblicke." />
        <meta property="og:description" content="High-End-Analytics – Tiefgehende Einrichtung von Google Analytics, Tag Manager und erweitertes Conversion-Tracking für maximale Einblicke." />
        <meta name="robots" content="index, follow" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content={`${APP_CONFIG.base_url}analytics-aufsetzung-premium`} />
        <meta property="og:image" content={logo} />
        <link rel="canonical" href="https://superagentur-marketing.de/analytics-aufsetzung-premium" />   
      </Helmet>
      ...
      <div className="max-w-[1173px] w-full mx-auto flex lg:flex-row flex-col lg:items-start items-center justify-between z-[2]">
        <motion.div
          ...
          <div className="leading-[30px] text-neutral-600 text-[18px] tb-medium mb-[28px]">
            Das Premium-Paket ist die ideale Wahl für Unternehmen, die maximale Transparenz und tiefgehende Einblicke in ihre Daten wünschen.
            Mit fortgeschrittenen Tracking-Möglichkeiten, individuell angepassten Dashboards und umfassender Unterstützung setzen wir neue Maßstäbe für Ihre Analyseprozesse.
          </div>
          <div className="flex flex-col gap-[15px] mb-10">
            ...
            <div className="flex items-center gap-[13px]">
              ...
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Alle Leistungen aus Basis und Standard-Paket:</div>
            </div>
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
            ...
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Grundlegendes Tracking</div>
            </div>
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
            ...
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Einrichtung und Konfiguration von erweiterten Events</div>
            </div>
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
            ...
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Einrichtung von Attributionsmodellen für Erfolgsmessung über mehrere Kanäle</div>
            </div>
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Integration von benutzerdefinierten Dashboards für visuelle Datenaufbereitung</div>
            </div>
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Fortgeschrittenes E-Commerce-Tracking (z. B. Warenkorbanalysen)</div>
            </div>
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Unterstützung bei der Verknüpfung mit weiteren Tools</div>
            </div>
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Beratung zur bestmöglichen Auswertung und Anwendung der Analyseergebnisse</div>
            </div>
          ...
          <ul className="pl-10 lg:mt-8 md:mt-[26px] mb-10 list-disc">
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Maximale Transparenz: Attributionsmodelle liefern umfassende Einblicke in die Performance Ihrer Marketingkanäle.</li>
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Detaillierte Dashboards: Individuelle Datenvisualisierung ermöglicht klare und präzise Analysen.</li>
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Erfolgsorientiertes Tracking: Fortgeschrittenes E-Commerce-Tracking zeigt detaillierte Verkaufs- und Nutzerverhaltensdaten.</li>
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Flexibilität und Integration: Nahtlose Verknüpfung mit weiteren Tools für eine umfassende Datenstrategie.</li>
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Umfassende Beratung: Wir unterstützen Sie dabei, Ihre Daten effektiv zu nutzen und gewinnbringende Maßnahmen abzuleiten.</li>

          </ul>
          <div className="leading-[30px] text-neutral-600 text-[18px] tb-medium mb-[28px]">
            Mit dem Premium-Paket erhalten Sie ein vollumfängliches Analyse-Setup, das alle relevanten Daten strukturiert und leicht verständlich darstellt, um Ihre Entscheidungen optimal zu unterstützen.
          </div>
        </motion.div>
        <motion.div
          variants={fadeInAnimationVariant}
          ...
          <div className="flex flex-col">
            ...
            <div className="leading-[30px] text-neutral-600 text-[18px] tb-medium">
              Wir helfen Ihnen, Ihre Analytics Aufsetzung-Ziele zu erreichen. Erfahren Sie mehr über Ihre Möglichkeiten und lassen Sie uns gemeinsam wachsen.
            </div>
...
export default AnalyticsAufsetzungPremium