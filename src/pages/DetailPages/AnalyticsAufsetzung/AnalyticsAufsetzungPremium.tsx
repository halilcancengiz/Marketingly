          ...
          <div className="lg:mt-8 md:mt-[26px] mb-10">
            <div className="flex gap-[13px]">
              ...
              <p className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2 flex items-start">
                Maximale Transparenz: Attributionsmodelle liefern umfassende Einblicke in die Performance Ihrer Marketingkanäle.
              </p>
            </div>
            <div className="flex gap-[13px]">
              <div className="size-6 flex items-center justify-center">
              ...
              <p className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2 flex items-start">
                Detaillierte Dashboards: Individuelle Datenvisualisierung ermöglicht klare und präzise Analysen.
              </p>
            </div>
            <div className="flex gap-[13px]">
              <div className="size-6 flex items-center justify-center">
              ...
              <p className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2 flex items-start">
                Erfolgsorientiertes Tracking: Fortgeschrittenes E-Commerce-Tracking zeigt detaillierte Verkaufs- und Nutzerverhaltensdaten.
              </p>
            </div>
            <div className="flex gap-[13px]">
              <div className="size-6 flex items-center justify-center">
              ...
              <p className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2 flex items-start">
                Flexibilität und Integration: Nahtlose Verknüpfung mit weiteren Tools für eine umfassende Datenstrategie.
              </p>
            </div>
            <div className="flex gap-[13px]">
              <div className="size-6 flex items-center justify-center">
              ...
              <p className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2 flex items-start">
                Umfassende Beratung: Wir unterstützen Sie dabei, Ihre Daten effektiv zu nutzen und gewinnbringende Maßnahmen abzuleiten.
              </p>
            </div>
          </div>
          <div className="leading-[30px] text-neutral-600 text-[18px] tb-medium mb-[28px]">
