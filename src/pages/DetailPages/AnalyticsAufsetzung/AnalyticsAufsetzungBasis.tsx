...
const AnalyticsAufsetzungBasis = () => {
  ...
  return (
    <section className="3xl:pt-[95px] lg:pt-[75px] md:pt-[60px] xs:pt-[50px] pt-[40px] 3xl:pb-[136px] lg:pb-[110px] md:pb-[88px] xs:pb-[70px] pb-[60px] px-6 flex items-center justify-center relative">
      ...
      <Helmet>
        <title>Analytics-Aufsetzung Basis Paket | Superagentur</title>
        <meta property="og:title" content="Analytics-Aufsetzung Basis Paket | Superagentur" />
        <meta name="description" content="Analytics-Aufsetzung für Einsteiger – Einrichtung von Google Analytics und Tag Manager für wichtige Einblicke." />
        <meta property="og:description" content="Analytics-Aufsetzung für Einsteiger – Einrichtung von Google Analytics und Tag Manager für wichtige Einblicke." />
        <meta name="robots" content="index, follow" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content={`${APP_CONFIG.base_url}analytics-aufsetzung-basis`} />
        <meta property="og:image" content={logo} />
        <link rel="canonical" href="https://superagentur-marketing.de/analytics-aufsetzung-basis" />
      </Helmet>
      ...
      <div className="max-w-[1173px] w-full mx-auto flex lg:flex-row flex-col lg:items-start items-center justify-between z-[2]">
        <motion.div
          ...
          <div className="leading-[30px] text-neutral-600 text-[18px] tb-medium mb-[28px]">
            Das Basis-Paket bietet Ihnen den idealen Einstieg in die Welt der Web-Analyse. Es richtet sich an Unternehmen, die eine solide Grundlage für ihre Datenerhebung schaffen möchten.
            Mit einem professionellen Setup sorgen wir dafür, dass Ihre wichtigsten Daten korrekt und DSGVO-konform erfasst werden, sodass Sie erste wertvolle Einblicke in das Nutzerverhalten gewinnen können.
          </div>
          ...
          <ul className="pl-10 lg:mt-8 md:mt-[26px] mb-10 list-disc">
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Effiziente Datenverwaltung: Wir stellen sicher, dass Ihre grundlegenden Tracking-Elemente korrekt implementiert sind, um präzise Daten zu liefern.</li>
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Verständliche Einblicke: Übersichtlich aufbereitete Berichte geben Ihnen eine klare Vorstellung vom Verhalten Ihrer Website-Besucher.</li>
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Rechtssicherheit: DSGVO-konformes Setup gewährleistet, dass Ihre Datenerhebung den gesetzlichen Anforderungen entspricht. </li>
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Professionelle Unterstützung: Unser Team steht Ihnen bei Fragen und für Anpassungen zur Verfügung.</li>
          </ul>
          <div className="leading-[30px] text-neutral-600 text-[18px] tb-medium mb-[28px]">
            Mit dem Basis-Paket legen Sie den Grundstein für Ihre Web-Analyse und erhalten eine solide Grundlage, um fundierte Entscheidungen zu treffen.
          </div>
        </motion.div>
        <motion.div
          variants={fadeInAnimationVariant}
...
export default AnalyticsAufsetzungBasis