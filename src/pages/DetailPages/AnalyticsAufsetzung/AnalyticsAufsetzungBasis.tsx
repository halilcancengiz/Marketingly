          ...
          <div className="lg:mt-8 md:mt-[26px] mb-10">
            <div className="flex gap-[13px]">
              ...
              <p className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2 flex items-start">
                Effiziente Datenverwaltung: Wir stellen sicher, dass Ihre grundlegenden Tracking-Elemente korrekt implementiert sind, um präzise Daten zu liefern.
              </p>
            </div>
            <div className="flex gap-[13px]">
              <div className="size-6 flex items-center justify-center">
              ...
              <p className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2 flex items-start">
                Verständliche Einblicke: Übersichtlich aufbereitete Berichte geben Ihnen eine klare Vorstellung vom Verhalten Ihrer Website-Besucher.
              </p>
            </div>
            <div className="flex gap-[13px]">
              <div className="size-6 flex items-center justify-center">
              ...
              <p className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2 flex items-start">
                Rechtssicherheit: DSGVO-konformes Setup gewährleistet, dass Ihre Datenerhebung den gesetzlichen Anforderungen entspricht.
              </p>
            </div>
            <div className="flex gap-[13px]">
              <div className="size-6 flex items-center justify-center">
              ...
              <p className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2 flex items-start">
                Professionelle Unterstützung: Unser Team steht Ihnen bei Fragen und für Anpassungen zur Verfügung.
              </p>
            </div>
          </div>
          <div className="leading-[30px] text-neutral-600 text-[18px] tb-medium mb-[28px]">
