      ...
      <div className="max-w-[1173px] w-full mx-auto flex lg:flex-row flex-col lg:items-start items-center justify-between z-[2]">
        <motion.div
          ...
          <ul className="pl-10 lg:mt-8 md:mt-[26px] mb-10 list-disc">
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Erweiterte Analysefunktionen: Detaillierte Insights durch Tracking von Nutzerinteraktionen wie Klicks oder Scroll-Tiefen.</li>
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Individuelle Anpassung: Wir richten das Tracking passgenau auf Ihre Geschäftsziele aus, um relevante Daten zu erfassen.</li>
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Erfolgsorientierte Optimierung: Conversion-Tracking hilft Ihnen, den Erfolg Ihrer Kampagnen besser zu messen und zu optimieren.</li>
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">E-Commerce-Fokus: Bei Bedarf analysieren wir Verkaufs- und Warenkorbdaten für eine gezielte Optimierung.</li>
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Professionelle Betreuung: Unser Team unterstützt Sie bei der Einrichtung und Anpassung für bestmögliche Ergebnisse.</li>
