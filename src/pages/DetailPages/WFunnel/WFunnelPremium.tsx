...
const WFunnelPremium = () => {
  ...
  return (
    <section className="3xl:pt-[95px] lg:pt-[75px] md:pt-[60px] xs:pt-[50px] pt-[40px] 3xl:pb-[136px] lg:pb-[110px] md:pb-[88px] xs:pb-[70px] pb-[60px] px-6 flex items-center justify-center relative">
      ...
      <Helmet>
        <title>Website-Funnel Premium Paket | Superagentur</title>
        <meta property="og:title" content="Website-Funnel Premium Paket | Superagentur" />
        <meta name="description" content="Funnels für maximale Umsätze – individuelle High-End-Lösungen für optimale Ergebnisse." />
        <meta property="og:description" content="Funnels für maximale Umsätze – individuelle High-End-Lösungen für optimale Ergebnisse." />
        <meta name="robots" content="index, follow" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content={`${APP_CONFIG.base_url}websitefunnel-premium`} />
        <meta property="og:image" content={logo} />
        <link rel="canonical" href="https://superagentur-marketing.de/websitefunnel-premium" />
      </Helmet>
      ...
      <div className="max-w-[1173px] w-full mx-auto flex lg:flex-row flex-col lg:items-start items-center justify-between z-[2]">
        <motion.div
          ...
          <h2 className="md:mb-[20px] xs:mb-[15px] mb-[10px] text-[16px] leading-[18px] uppercase tb-medium text-primary tracking-[1.5px] mt-10">Website-Funnel</h2>
          ...
          <div className="leading-[30px] text-neutral-600 text-[18px] tb-medium mb-[28px]">
            Das Premium-Paket bietet die umfassendste Lösung für Unternehmen, die maximale Performance und Skalierbarkeit suchen.
            Mit unbegrenzten Funnels, fortschrittlichen Automatisierungen und dynamischen Tests bleiben Sie der Konkurrenz immer einen Schritt voraus.
          </div>
          <div className="flex flex-col gap-[15px] mb-10">
            ...
            <div className="flex items-center gap-[13px]">
              ...
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Erstellung und Verwaltung einer unbegrenzten Anzahl von Funnels</div>
            </div>
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Erweiterte Automatisierungen und dynamische A/B-Tests zur Optimierung</div>
            </div>
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Dynamische Anpassungen basierend auf Echtzeit-Daten und Nutzerverhalten</div>
            </div>
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Regelmäßige Optimierung für maximale Kampagnenleistung und Conversions</div>
            </div>
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Strategische Planung und fortlaufende Betreuung durch Experten</div>
            </div>
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Monatliches Reporting zur Analyse und Verbesserung</div>
            </div>
          </div>
          ...
          <ul className="pl-10 lg:mt-8 md:mt-[26px] mb-10 list-disc">
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Maximale Flexibilität mit unbegrenzten Funnels und personalisierten Lösungen</li>
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Fortgeschrittene Automatisierungen für nahtlose Abläufe</li>
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Dynamische Tests und Anpassungen für stetige Optimierung</li>
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Langfristige Betreuung durch Experten für nachhaltigen Erfolg</li>
          </ul>
          <div className="leading-[30px] text-neutral-600 text-[18px] tb-medium mb-[28px]">
            Mit dem Premium-Paket sichern Sie sich die besten Ergebnisse und setzen neue Standards für Ihre Funnels.
          </div>
        </motion.div>
        <motion.div
          variants={fadeInAnimationVariant}
          ...
          <div className="flex flex-col">
            ...
            <div className="leading-[30px] text-neutral-600 text-[18px] tb-medium">
              Wir helfen Ihnen, Ihre Website Funnel-Ziele zu erreichen. Erfahren Sie mehr über Ihre Möglichkeiten und lassen Sie uns gemeinsam wachsen.
            </div>
            <div className="flex flex-col my-5">
              <div className="tb-bold text-neutral-800 md:text-[24px] xs:text-[22px] text-[20px] md:leading-[34.008px] xs:leading-[31.174px] leading-[28.34px]">{APP_CONFIG.prices.Website_Funnel.premium}</div>
