          ...
          <div className="lg:mt-8 md:mt-[26px] mb-10">
            <div className="flex gap-[13px]">
              ...
              <p className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2 flex items-start">
                Effiziente Erstellung eines einfachen Funnels für erste Ergebnisse
              </p>
            </div>
            <div className="flex gap-[13px]">
              <div className="size-6 flex items-center justify-center">
              ...
              <p className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2 flex items-start">
                Klare Struktur, um neue Leads zu gewinnen
              </p>
            </div>
            <div className="flex gap-[13px]">
              <div className="size-6 flex items-center justify-center">
              ...
              <p className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2 flex items-start">
                Transparente Betreuung und schnelle Anpassungen bei Bedarf
              </p>
            </div>
            <div className="flex gap-[13px]">
              <div className="size-6 flex items-center justify-center">
              ...
              <p className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2 flex items-start">
                Optimiert für eine einfache und zielgerichtete Nutzung
              </p>
            </div>
