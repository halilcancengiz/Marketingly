...
const WFunnelBasis = () => {
  ...
  return (
    <section className="3xl:pt-[95px] lg:pt-[75px] md:pt-[60px] xs:pt-[50px] pt-[40px] 3xl:pb-[136px] lg:pb-[110px] md:pb-[88px] xs:pb-[70px] pb-[60px] px-6 flex items-center justify-center relative">
      ...
      <Helmet>
        <title>Website-Funnel Basis Paket | Superagentur</title>
        <meta property="og:title" content="Website-Funnel Basis Paket | Superagentur" />
        <meta name="description" content="Funnels für Einsteiger – funktionale Lösungen, die Ihre Leads in zahlende Kunden verwandeln." />
        <meta property="og:description" content="Funnels für Einsteiger – funktionale Lösungen, die Ihre Leads in zahlende Kunden verwandeln." />
        <meta name="robots" content="index, follow" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content={`${APP_CONFIG.base_url}websitefunnel-basis`} />
        <meta property="og:image" content={logo} />
        <link rel="canonical" href="https://superagentur-marketing.de/websitefunnel-basis" />
      </Helmet>
      ...
      <div className="max-w-[1173px] w-full mx-auto flex lg:flex-row flex-col lg:items-start items-center justify-between z-[2]">
        <motion.div
          ...
          <div className="leading-[30px] text-neutral-600 text-[18px] tb-medium mb-[28px]">
            Das Basis-Paket bietet Ihnen den perfekten Einstieg in die Welt der Funnels. Es ist ideal für Unternehmen, die erste Leads generieren möchten und eine einfache Lösung suchen, um ihre Conversion-Raten zu verbessern.
          </div>
          <div className="flex flex-col gap-[15px] mb-10">
            ...
            <div className="flex items-center gap-[13px]">
              ...
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Erstellung eines simplen Funnels zur Lead-Generierung</div>
            </div>
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
            ...
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Optimiert für erste Kampagnen und Conversions</div>
            </div>
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
            ...
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Grundlegende Betreuung und Support</div>
            </div>
          </div>
          ...
          <ul className="pl-10 lg:mt-8 md:mt-[26px] mb-10 list-disc">
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Effiziente Erstellung eines einfachen Funnels für erste Ergebnisse</li>
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Klare Struktur, um neue Leads zu gewinnen</li>
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Transparente Betreuung und schnelle Anpassungen bei Bedarf</li>
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Optimiert für eine einfache und zielgerichtete Nutzung</li>
          </ul>
          <div className="leading-[30px] text-neutral-600 text-[18px] tb-medium mb-[28px]">
            Mit dem Basis-Paket legen Sie den Grundstein für erfolgreiche Funnels und erste Conversions.
          </div>
        </motion.div>
        <motion.div
          variants={fadeInAnimationVariant}
