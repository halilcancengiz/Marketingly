  ...
  return (
    <section className="3xl:pt-[95px] lg:pt-[75px] md:pt-[60px] xs:pt-[50px] pt-[40px] 3xl:pb-[136px] lg:pb-[110px] md:pb-[88px] xs:pb-[70px] pb-[60px] px-6 flex items-center justify-center relative">
      ...
      {/* <Helmet>
        ...
        <meta name="description" content="E-Mail-Marketing für maximale Performance – High-End-Lösungen mit vollständiger Automatisierung und Skalierbarkeit." />
        <meta property="og:description" content="E-Mail-Marketing für maximale Performance – High-End-Lösungen mit vollständiger Automatisierung und Skalierbarkeit." />
        <meta name="robots" content="index, follow" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content={`${APP_CONFIG.base_url}email-marketing-premium`} />
        <meta property="og:image" content={logo} />
        <link rel="canonical" href="https://superagentur-marketing.de/email-marketing-premium" />
      </Helmet> */}
      ...
      <div className="max-w-[1173px] w-full mx-auto flex lg:flex-row flex-col lg:items-start items-center justify-between z-[2]">
        <motion.div
          ...
          <div className="leading-[30px] text-neutral-600 text-[18px] tb-medium mb-[28px]">
            Das Premium-Paket bietet die umfassendste Lösung für Unternehmen mit hohen Ansprüchen an ihr E-Mail-Marketing.
            Mit fortschrittlichen Strategien, komplexen Automatisierungen und maßgeschneiderten Lösungen erreichen Sie Ihre Ziele effizient und nachhaltig.
          </div>
          <div className="flex flex-col gap-[15px] mb-10">
            ...
            <div className="flex items-center gap-[13px]">
              ...
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Unbegrenzte Anzahl an Kampagnen</div>
            </div>
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Optimierung und Erstellung komplexer Opt-in- und Lead-Generierungs-Formulare</div>
            </div>
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Verwaltung von unbegrenzten Kontakten</div>
            </div>
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Fortgeschrittene Segmentierung</div>
            </div>
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Detailliertes Reporting mit Handlungsempfehlungen</div>
            </div>
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Komplexe Automatisierungen</div>
            </div>
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Strategische Planung und regelmäßige Überwachung Ihrer Kampagnen</div>
            </div>
          </div>
...
export default EmailMarketingPremium