  ...
  return (
    <section className="3xl:pt-[95px] lg:pt-[75px] md:pt-[60px] xs:pt-[50px] pt-[40px] 3xl:pb-[136px] lg:pb-[110px] md:pb-[88px] xs:pb-[70px] pb-[60px] px-6 flex items-center justify-center relative">
      ...
      <Helmet>
        ...
        <meta property="og:description" content="E-Mail-Marketing für Einsteiger – automatisierte Kampagnen für eine effektive und unkomplizierte Kundenkommunikation." />
      ...
      <div className="max-w-[1173px] w-full mx-auto flex lg:flex-row flex-col lg:items-start items-center justify-between z-[2]">
        <motion.div
          ...
          <div className="leading-[30px] text-neutral-600 text-[18px] tb-medium mb-[28px]">
            Das Basis-Paket bietet Ihnen den idealen Einstieg ins E-Mail-Marketing.
            Es richtet sich an Unternehmen, die mit gezielten Kampagnen erste Erfolge erzielen möchten und dabei auf eine DSGVO-konforme Grundlage setzen.
            Mit einfacher Einrichtung und klarer Struktur helfen wir Ihnen, Ihre Zielgruppe effizient zu erreichen.
          </div>
          <div className="flex flex-col gap-[15px] mb-10">
            ...
            <div className="flex items-center gap-[13px]">
              ...
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Erstellung und Versand von bis zu 2 Kampagnen</div>
            </div>
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">DSGVO-konforme Einrichtung von Opt-in-Formularen</div>
            </div>
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Verwaltung von bis zu 1.000 Kontakten</div>
            </div>
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
            ...
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Grundlegende Segmentierung Ihrer Kontakte</div>
            </div>
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Einrichtung einfacher Automatisierungen</div>
            </div>
          </div>
          ...
          <ul className="pl-10 lg:mt-8 md:mt-[26px] mb-10 list-disc">
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Effiziente Verwaltung Ihrer E-Mail-Kampagnen mit minimalem Aufwand</li>
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Klare Berichte, die Ihnen einen Überblick über Ihre Erfolge bieten</li>
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Einfache Automatisierungen für erste Schritte in der Prozessoptimierung</li>
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Transparente und DSGVO-konforme Datenverwaltung</li>
          </ul>
          <div className="leading-[30px] text-neutral-600 text-[18px] tb-medium mb-[28px]">
            Mit dem Basis-Paket legen Sie den Grundstein für Ihr E-Mail-Marketing und erste nachhaltige Ergebnisse.
          </div>
        </motion.div>
        <motion.div
          variants={fadeInAnimationVariant}
...
export default EmailMarketingBasis