...
const EmailMarketingStandard = () => {
  ...
  return (
    <section className="3xl:pt-[95px] lg:pt-[75px] md:pt-[60px] xs:pt-[50px] pt-[40px] 3xl:pb-[136px] lg:pb-[110px] md:pb-[88px] xs:pb-[70px] pb-[60px] px-6 flex items-center justify-center relative">
      ...
      <Helmet>
        <title>E-Mail-Marketing Standard Paket | Superagentur</title>
        <meta property="og:title" content="E-Mail-Marketing Standard Paket | Superagentur" />
        <meta name="description" content="E-Mail-Marketing für wachsendes Unternehmen – maßgeschneiderte Strategien, die Ihre Zielgruppe optimal erreichen." />
        <meta property="og:description" content="E-Mail-Marketing für wachsendes Unternehmen – maßgeschneiderte Strategien, die Ihre Zielgruppe optimal erreichen." />
        <meta name="robots" content="index, follow" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content={`${APP_CONFIG.base_url}email-marketing-standard`} />
        <meta property="og:image" content={logo} />
        <link rel="canonical" href="https://superagentur-marketing.de/email-marketing-standard" />
      </Helmet>
      ...
      <div className="max-w-[1173px] w-full mx-auto flex lg:flex-row flex-col lg:items-start items-center justify-between z-[2]">
        <motion.div
          ...
          <div className="leading-[30px] text-neutral-600 text-[18px] tb-medium mb-[28px]">
            Das Standard-Paket ist ideal für Unternehmen, die ihr E-Mail-Marketing professionalisieren und skalieren möchten.
            Mit individuellen Lösungen und strategischer Beratung schaffen wir die Basis für langfristigen Erfolg und eine effektivere Zielgruppenansprache.
          </div>
          <div className="flex flex-col gap-[15px] mb-10">
            ...
            <div className="flex items-center gap-[13px]">
              ...
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Erstellung und Versand von bis zu 5 Kampagnen</div>
            </div>
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Individuelle Gestaltung von Opt-in-Formularen zur Lead-Generierung</div>
            </div>
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Verwaltung von bis zu 5.000 Kontakten</div>
            </div>
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Monatliches Reporting mit detaillierten Analysen</div>
            </div>
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Erweiterte Segmentierung</div>
            </div>
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Automatisierte Workflows</div>
            </div>
            <div className="flex items-center gap-[13px]">
              <img loading="lazy" className="size-6 rounded-full" src={check} alt="check" />
              <div className="leading-[20px] text-neutral-800 text-[18px] tb-medium">Strategische Beratung zur Zielgruppenansprache</div>
            </div>
          </div>
          ...
          <ul className="pl-10 lg:mt-8 md:mt-[26px] mb-10 list-disc">
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Professionelle Gestaltung und Optimierung Ihrer E-Mail-Marketing-Maßnahmen</li>
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Gezielte Segmentierung für personalisierte Inhalte und höhere Conversion-Raten</li>
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Automatisierte Prozesse für mehr Effizienz und Zeitersparnis</li>
            <li className="xs:text-[18px] text-base text-neutral-600 tb-medium leading-[30px] mb-2">Umfangreiche Berichte zur besseren Entscheidungsfindung</li>
          </ul>
          <div className="leading-[30px] text-neutral-600 text-[18px] tb-medium mb-[28px]">
            Mit dem Standard-Paket können Sie Ihr E-Mail-Marketing auf das nächste Level bringen und Ihre Ergebnisse nachhaltig verbessern.
          </div>
        </motion.div>
        <motion.div
          variants={fadeInAnimationVariant}
...
export default EmailMarketingStandard