    ...
    return (
        <main className="flex flex-col overflow-x-hidden">
            ...
            <section className="homeV2FirstSection lg:-mt-[230px] md:-mt-[260px] xs:-mt-[130px] -mt-[120px] max-w-[1173px] w-full mx-auto relative z-[2]">
                <img className="w-full" src={homeV2HeroImage} alt="" />
                <div className="absolute top-[40%] -translate-y-[45%]  flex items-center justify-between w-full px-6">
                    <img className="max-w-[21.896%] w-full md:rounded-[19px] rounded-[10px] border border-neutral-300 shadow" src={homeV2Chart1Image} alt="" />
                    <img className="max-w-[22.9%] md:rounded-[19px] rounded-[10px] border border-neutral-300 shadow" src={homeV2Chart2Image} alt="" />
                </div>
            </section>
