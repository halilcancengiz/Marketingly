        ...
        <main className="flex flex-col overflow-x-hidden">
            ...
            <section className="homeV2Container 3xl:pt-[167px] lg:pt-[134px] md:pt-[60px] xs:pt-[50px] pt-10 flex flex-col items-start px-6 3xl:h-[795px] lg:h-[735px] md:h-[657px] xs:h-[515px] h-[599px]  relative bg-secondary1 z-[1]">
                <div className="max-w-[632px] w-full mx-auto flex flex-col lg:mb-[86px] md:mb-[72px] xs:mb-[60px] mb-[50px] bg-transparent z-[3]">
                    <div className="lg:text-[54px] md:text-[45px] xs:text-[38px] text-[32px] lg:leading-[61px] md:leading-[50.85px] xs:leading-[42.94px] leading-[36.16px] font-bold text-white text-center mb-[10px]">Maximaler Erfolg mit <br /> <span className="whitespace-nowrap font-bold">Google!</span></div>
                    <div className="leading-[30px] text-white text-center mb-10 text-[18px] font-medium">Mit uns erreichen Sie Menschen dort wo sie suchen, auf Google - durch Ads, Seo & Unternehmenslistungen.</div>
                    <div className="flex xs:flex-row flex-col items-center justify-center gap-7 pb-3.5">
                        <NavLink className="xs:w-auto w-full" to="/contact">
                            <Button className="xs:w-auto w-full font-bold !text-primary bg-white hover:!bg-secondary3 hover:!text-white" variant="primary" size="default">Kontakt</Button>
                        </NavLink>
                        <a className="xs:w-auto w-full" href="#unsereDienstleistungen">
                            <Button className="w-full font-medium border-white text-white hover:!bg-secondary3" variant="secondary" size="default">Mehr Infos</Button>
                        </a>
