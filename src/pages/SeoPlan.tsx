...
const SeoPlan = () => {
    return (
        <div className="flex flex-col">
            <Helmet>
                <title>SEO Plan - Flexible Lösungen für jedes Budget | MARKETINGLY X</title>
                <meta name="description" content="Unsere SEO-Pläne bieten flexible Lösungen für jedes Budget und jeden Bedarf. Entdecken Sie unsere Preismodelle für Social Media Marketing, SEO und Paid Advertising." />
                <meta property="og:title" content="SEO Plan - Flexible Lösungen für jedes Budget | MARKETINGLY X" />
                <meta property="og:description" content="Flexible SEO-Preismodelle für maximale Sichtbarkeit und Reichweite. Finden Sie den passenden Plan für Ihre Marketingziele!" />
                <meta property="og:type" content="website" />
                <meta property="og:url" content={`${import.meta.env.VITE_BASE_URL}seo-plan`} />
