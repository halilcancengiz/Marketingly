...
export const Logo = () => {
    return (
        <NavLink className="flex items-center gap-2.5 whitespace-nowrap max-w-[295px] min-h-[35px] w-full" aria-label="Open home page" to="/">
            <svg className="max-h-[35px]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 535 549" fill="none">
